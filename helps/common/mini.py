    ...
    def getuserdetails(self, classOBJpackage, personalDetails, officialDetails, salaryAndLeaves, created_by): # New
        ...
        if 'bank_account' in salaryAndLeaves:
            ...
            if not addbankaccountdetails['flag']:
                response['message'].extend([f'bankaccount - {each}' for each in addbankaccountdetails['message']])
                response['flag'] = False
                addbankaccountdetails = None
                # return response
        ...
        if 'present_address' in personalDetails:
            ...
            if not presentaddressdetails['flag']:
                response['message'].extend([f'present address - {each}' for each in presentaddressdetails['message']])
                response['flag'] = False
                presentaddressdetails = None
        ...
        if 'permanent_address' in personalDetails:
            ...
            if not permanentaddressdetails['flag']:
                response['message'].extend([f'permanet address - {each}' for each in permanentaddressdetails['message']])
                response['flag'] = False
                permanentaddressdetails = None
        ...
        response['data'] = {
            ...
            'present_address': presentaddressdetails['instance'] if presentaddressdetails != None else None,
            'permanent_address': permanentaddressdetails['instance'] if permanentaddressdetails != None else None,
