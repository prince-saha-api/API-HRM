...
INSTALLED_APPS = [
    ...
    'workingshift.apps.WorkingshiftConfig',
    'officialoffday.apps.OfficialoffdayConfig',
    'salarycalculation.apps.SalarycalculationConfig',
    'costcalculation.apps.CostcalculationConfig',
