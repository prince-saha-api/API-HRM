    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('marital_status', models.CharField(choices=[('Single', 'Single'), ('Married', 'Married'), ('Widowed', 'Widowed'), ('Divorced', 'Divorced'), ('Separated ', 'Separated')], default='Single', max_length=20)),
                ...
                ('payment_in', models.CharField(blank=True, max_length=50, null=True)),
