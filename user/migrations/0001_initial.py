    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('official_id', models.CharField(blank=True, max_length=11, null=True, unique=True)),
                ('official_email', models.EmailField(blank=True, max_length=254)),
                ('official_phone', models.CharField(blank=True, max_length=14, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attachment', models.FileField(blank=True, null=True, upload_to=user.models.upload_employee_docs)),
