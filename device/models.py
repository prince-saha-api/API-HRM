...
class Device(Basic):
    ...
    username = models.CharField(max_length=50, blank=True, null=True, default='admin')
    password = models.CharField(max_length=50, blank=True, null=True, default='admin1234')
